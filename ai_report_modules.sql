...
INSERT INTO ai_report_modules (label, description, family, default_rule) VALUES
('Discourse Analysis', 'Detailed linguistic analysis of discourse markers, cohesion, and pragmatics', 'Linguistic Analysis', 'Conduct discourse analysis: 1) Discourse markers and connectives usage, 2) Cohesion and coherence devices, 3) Topic management and development, 4) Reference and ellipsis patterns, 5) Pragmatic features (politeness, indirectness, implicature).'),

('Syntax & Complexity', 'Analysis of syntactic structures and sentence complexity metrics', 'Linguistic Analysis', 'Analyze syntactic features: 1) Sentence length variation, 2) Clause types and subordination, 3) Syntactic complexity index, 4) Passive vs active voice distribution, 5) Coordination and subordination balance. Include quantitative metrics.'),

('Lexical Analysis', 'Comprehensive lexical statistics including type-token ratio and frequency patterns', 'Linguistic Analysis', 'Perform lexical analysis: 1) Type-token ratio (already calculated), 2) Lexical density, 3) Word frequency distribution, 4) Semantic fields and domains, 5) Lexical sophistication indices. Provide comparative benchmarks.'),

('Filler Analysis', 'Detailed examination of fillers, hesitations, and disfluency patterns', 'Linguistic Analysis', 'Examine disfluency patterns: 1) Filler word distribution (um, uh, er, etc.), 2) False starts and self-repairs, 3) Pause patterns (estimated from transcript), 4) Repetition types, 5) Strategic vs problematic disfluencies. Already have fillers_per_minute metric.');
