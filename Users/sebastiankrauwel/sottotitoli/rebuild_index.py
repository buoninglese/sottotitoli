...
# ============================================================
# STEP 2: Extract inner content from blocks
# ============================================================
...
# For lang grid, just take the lang-cards-grid
...
# ============================================================
# STEP 3: Build new unified sections
# ============================================================
...
# Intro
sections.append('''<section class="page-section" style="padding:16px 24px 0;">
...
# Come funziona
sections.append('''<section class="page-section page-section-alt">
...
# Lingue
sections.append('''<section class="page-section">
  <div class="page-section-inner">
    <div class="page-section-header">
...
# Footer
sections.append('''<section class="page-section" style="padding-bottom:0;">
  <div class="page-section-inner">
    ''' + footer_clean + '''
  </div>
</section>''')
...
print(f"Pricing block: {'block-20' in c}")
