...
(function(){
  ...
  var DICT = {
    it: {
      ...
      "rai_my_reports": "I miei Report",      "metric_total_sessions": "Sessioni totali",
      ...
      "chart_loading": "Caricamento…",
      "chart_login_needed": "Accedi per vedere il grafico",
      "chart_error": "Errore nel caricamento",
      "sidebar_workspace": "Workspace",
      "sidebar_learning": "Apprendimento",
      "sidebar_reports": "Report",
      "sidebar_vocab_builder": "Vocabulary Builder",
      "sidebar_grammar_hub": "Grammar Hub",
      "sidebar_ai_voice": "AI Voice",
      "sidebar_premium": "PREMIUM",
      "sidebar_coming_soon": "In arrivo",
      "topbar_skip": "Vai al contenuto principale",
      ...
      "ss_caption_title": "Sottotitoli in<br><em>una sola lingua</em>",
      ...
      "ss_pick_lang": "Scegli la lingua",
      "ss_confirm": "Conferma",
      "ss_translate_tag": "Translate",
      "ss_translate_title": "Traduzione<br><em>in tempo reale</em>",
      "ss_translate_desc": "Scegli la lingua che parli e quella per i sottotitoli.",
      "ss_translate_spoken": "parlato",
      "ss_translate_subs": "sottotitoli",
      ...
      "prof_sessions": "Sessioni",
      "prof_exposure": "Esposizione",
      "prof_hrs": "Ore",
      "prof_unique_words": "Parole Uniche",
      "prof_momentum": "Momentum",
      "prof_days": "Giorni",
      "prof_lexicon": "Lessico",
      "prof_curriculum": "Curriculum",
      "prof_invite": "Invita amici",
      "prof_invite_desc": "Condividi la tua passione per le lingue. Guadagni <strong style=\"color:var(--accent-green)\">15 minuti</strong> per ogni amico che si iscrive.",
      "prof_ref_link": "Link Referral",
      "prof_share_wa": "Condividi su WhatsApp",
      "prof_share_email": "Invia tramite Email",
      "tr_all": "Tutte",
      ...
      "tr_search_placeholder": "Cerca sessioni...",
      "tr_download_list": "Scarica Lista",
      "tr_col_date": "Data",
      "tr_col_session": "Sessione",
      "tr_col_tags": "Tag",
      "tr_col_duration": "Durata",
      "tr_col_words": "Parole",
      "tr_col_language": "Lingua",
      "tr_col_actions": "Azioni",
      "tr_empty": "Nessuna sessione trovata. Inizia una sessione di caption o traduzione.",
      "tr_bulk_none": "0 selezionate",
      "tr_bulk_tag": "Aggiungi tag…",
      "tr_bulk_apply": "Applica Tag",
      "tr_bulk_delete": "Elimina Selezionate",
      "help_desc": "Domande frequenti sul sistema di report, crediti, e sull'affidabilità delle analisi.",
      ...
      "rai_settings": "Impostazioni",      "metric_total_sessions": "Sessioni totali",
      "metric_spoken_time": "Tempo parlato",
      "metric_unique_words": "Parole uniche",
      "metric_gse_score": "Punteggio GSE",
      "metric_lexical_div": "Div. lessicale",
      "chart_session_minutes": "Minuti di sessione",
      "chart_subtitle": "Analisi della tua costanza verbale negli ultimi 14 giorni.",
      "chart_minutes_total": "Minuti Totali",
      "chart_loading": "Caricamento…",
      "chart_login_needed": "Accedi per vedere il grafico",
      "chart_error": "Errore nel caricamento",
      ...
      "tr_bulk_apply": "Applica Tag",
      "tr_bulk_delete": "Elimina Selezionate",
      "tr_filter_tag": "Filtra per Tag",
      "tr_new_tag_placeholder": "Nuovo tag...",
      "tr_add_tag": "+ Aggiungi Tag",
      "tr_editor_title": "Pannello Editor",
      "tr_editor_select": "Seleziona una sessione da modificare.",
      "settings_desc": "Personalizza il tuo ambiente di apprendimento e l'aspetto dell'app.",
      "settings_lang_captions": "Lingua e captions",
      "settings_site_lang": "Lingua sito",
    ...
    en: {
      ...
      "chart_subtitle": "Analyzing your verbal consistency over the last 14 days.",
      "chart_minutes_total": "Minutes Total",
      "chart_loading": "Loading…",
      "chart_login_needed": "Sign in to see the chart",
      ...
      "home": "Home",
      "ss_caption_tag": "Caption",
      "ss_caption_title": "Captions in<br><em>a single language</em>",
      ...
      "ss_pick_lang": "Choose language",
      "ss_confirm": "Confirm",
      "ss_translate_tag": "Translate",
      "ss_translate_title": "Real-time<br><em>translation</em>",
      "ss_translate_desc": "Choose the language you speak and the one for subtitles.",
      "ss_translate_spoken": "spoken",
      "ss_translate_subs": "subtitles",
      ...
      "prof_exposure": "Exposure",
      "prof_hrs": "Hrs",
      "prof_unique_words": "Unique Words",
      "prof_momentum": "Momentum",
      "prof_days": "Days",
      "prof_lexicon": "Language Lexicon",
      "prof_curriculum": "Curriculum",
      "prof_invite": "Invite friends",
      "prof_invite_desc": "Share your passion for languages. Earn <strong style=\"color:var(--accent-green)\">15 minutes</strong> for every friend who signs up.",
      "prof_ref_link": "Referral Link",
      "prof_share_wa": "Share on WhatsApp",
      "prof_share_email": "Send via Email",
      "tr_all": "All",
      ...
      "tr_search_placeholder": "Search sessions...",
      "tr_download_list": "Download List",
      "tr_col_date": "Date",
      "tr_col_session": "Session",
      "tr_col_tags": "Tags",
      "tr_col_duration": "Duration",
      ...
      "tr_empty": "No sessions found. Start a caption or translation session.",
      "tr_bulk_none": "0 selected",
      "tr_bulk_tag": "Tag selected…",
      "tr_bulk_apply": "Apply Tag",
      "tr_bulk_delete": "Delete Selected",
      "tr_filter_tag": "Filter by Tag",
      "tr_new_tag_placeholder": "New tag name...",
      "tr_add_tag": "+ Add Tag",
      "tr_editor_title": "Editor Panel",
      "tr_editor_select": "Select a session to edit.",
      ...
      "sidebar_premium": "PREMIUM",
      "sidebar_coming_soon": "Coming soon",
      "topbar_skip": "Skip to main content",
      "topbar_toggle_theme": "Toggle color theme",
      "topbar_notifications": "Notifications",
      "topbar_account": "Account",
      "notifications_empty": "No notifications",
      ...
      "rai_settings": "Settings",      "settings_system": "System",
      "help_desc": "Frequently asked questions about the report system, credits, and analysis reliability.",
      // ── AI Reports settings ──
      ...
      "settings_def_trans": "Default translation",
      "rai_create": "Create Report",
      "rai_my_reports": "My Reports",      "purchase_includes": "Includes",
