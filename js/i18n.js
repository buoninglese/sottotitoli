...
(function(){
  ...
  var DICT = {
    it: {
      ...
      "mode_pos": "View POS",
      "slide_style": "Stile",
      "slide_captions": "Didascalie",
      "slide_vocab": "Vocabolario",
      "slide_words": "Parole",
      "slide_grammar": "Grammatica",
      "listen": "Ascolta",
      "pause": "Pausa",
      "stop": "Stop",
      "mic_off": "Mic Off",
      ...
      "purchase_feat_bonus": "+25% bonus fedeltà",
      "purchase_feat_unlock": "Report AI sbloccato",
      "purchase_feat_support": "Supporto prioritario",
      "purchase_feat_noexpiry": "Non scadono mai",
      "purchase_feat_vocab": "Vocabolario: 1 cr",
      "purchase_feat_session": "Sessione: 3 cr",
      "purchase_howto": "Come funziona",
      "purchase_howto_text": "Scegli uno dei quattro pacchetti qui sopra. I minuti sono utilizzabili per caption e traduzione. I crediti AI servono per generare Report AI dopo le sessioni. Tutti i pacchetti includono il +25% di bonus fedeltà.",
    ...
    en: {
      ...
      "purchase_feat_noexpiry": "Never expire",
      "purchase_feat_vocab": "Vocabulary: 1 cr",
      "purchase_feat_session": "Session: 3 cr",
      "purchase_howto": "How it works",
      "purchase_howto_text": "Choose one of the four packages above. Minutes can be used for caption and translation. AI credits are used to generate AI Reports after sessions. All packages include the +25% loyalty bonus.",
