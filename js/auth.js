...
(function(){
  ...
  if(path==='index.html'||path===''||path==='404.html'||path==='panoramica.html'||path==='studio-caption.html'||path==='studio-sotto.html'||path==='studio-traduzione.html'||path.indexOf('overlay')===0)return;
