...
[Writing & Docs](https://www.mdskills.ai/skills?category=writing-docs) Intermediate

Creating and refining Mermaid diagrams with live reload. Use when users want flowcharts, sequence diagrams, class diagrams, ER diagrams, state diagrams, or any other Mermaid visualization. Provides best practices for syntax, styling, and the iterative workflow using mermaid\_preview and mermaid\_save tools.

9.0advisor521popularity17downloads [by veelenga](https://www.mdskills.ai/u/veelenga)

`npx mdskills install veelenga/mermaid-diagrams`
...
Are you `@veelenga`? [Sign in with GitHub](https://www.mdskills.ai/login?next=/skills/mermaid-diagrams) to claim this listing.

Skill Advisor9.0 [How we review skills](https://www.mdskills.ai/docs/skill-advisor "How we review skills")

Comprehensive guide with clear workflow, diagram types, and best practices for iterative diagramming

- +Provides detailed examples for all major Mermaid diagram types with syntax patterns
- +Establishes clear iterative workflow using preview\_id for live reload refinement
- +Includes proactive behaviors and common pitfalls with solutions
- -Could specify when to avoid using live reload for performance or security-sensitive diagrams

[Overview](https://www.mdskills.ai/skills/mermaid-diagrams) [Source Code](https://www.mdskills.ai/skills/mermaid-diagrams?tab=source) [Installation](https://www.mdskills.ai/skills/mermaid-diagrams?tab=installation) [Forks (0)](https://www.mdskills.ai/skills/mermaid-diagrams?tab=forks) [Comments (0)](https://www.mdskills.ai/skills/mermaid-diagrams?tab=comments)
...
MIT - see [LICENSE](https://www.mdskills.ai/skills/LICENSE) file for details
...
[claude-code](https://www.mdskills.ai/tags/claude-code) [mcp](https://www.mdskills.ai/tags/mcp) [documentation](https://www.mdskills.ai/tags/documentation) [browser](https://www.mdskills.ai/tags/browser)
...
Updated 2/24/2026· [View source on GitHub](https://github.com/veelenga/claude-mermaid)

## Frequently Asked Questions

### What is Mermaid Diagrams?

Mermaid Diagrams is a free, open-source AI agent skill. Creating and refining Mermaid diagrams with live reload. Use when users want flowcharts, sequence diagrams, class diagrams, ER diagrams, state diagrams, or any other Mermaid visualization. Provides best practices for syntax, styling, and the iterative workflow using mermaid\_preview and mermaid\_save tools.
...
### What platforms support Mermaid Diagrams?

Mermaid Diagrams works withClaude Code, Claude Desktop, Cursor, Vscode Copilot, Windsurf, Continue Dev, Codex, Gemini Cli, Amp, Roo Code, Goose, Opencode, Trae, Qodo, Command Code. Skills use the open SKILL.md format which is compatible with any AI coding agent that reads markdown instructions.

## Creator

[![veelenga avatar](https://github.com/veelenga.png?size=80)\\
\\
veelenga\\
\\
@veelenga](https://www.mdskills.ai/u/veelenga) [View on GitHub](https://github.com/veelenga)
...
CategoryWriting & Docs

Difficultyintermediate

LicenseMIT

Skill Advisor [How we review skills](https://www.mdskills.ai/docs/skill-advisor "How we review skills")Verified · 9.0

GitHub71 stars10 forks
...
[Install guide](https://www.mdskills.ai/docs/install-skills) [View on GitHub](https://github.com/veelenga/claude-mermaid)
